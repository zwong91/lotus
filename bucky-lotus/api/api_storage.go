...
type StorageMiner interface {
	...
	// @Added by <wangzhi@buckyos.com> 2022-01-26 for lotus-miner sectors counter cmd
	...
	ReturnDispatchWPoSt(ctx context.Context, callID storiface.CallID, err *storiface.CallError) error                             //perm:admin retry:true
