...
type StorageMinerStruct struct {
	...
	Internal struct {
		...
		ReturnDispatchWPoSt func(p0 context.Context, p1 storiface.CallID, p2 *storiface.CallError) error `perm:"admin"`
...
type WorkerStruct struct {
	Internal struct {
		...
		DispatchWPoSt func(p0 context.Context, p1 storage.SectorRef, p2 int, p3 int, p4 int) (storiface.CallID, error) `perm:"admin"`
...
func (s *StorageMinerStruct) ReturnDispatchWPoSt(p0 context.Context, p1 storiface.CallID, p2 *storiface.CallError) error {
	if s.Internal.ReturnDispatchWPoSt == nil {
		return ErrNotSupported
	}
	return s.Internal.ReturnDispatchWPoSt(p0, p1, p2)
}

func (s *StorageMinerStub) ReturnDispatchWPoSt(p0 context.Context, p1 storiface.CallID, p2 *storiface.CallError) error {
	return ErrNotSupported
}
...
func (s *WorkerStruct) DispatchWPoSt(p0 context.Context, p1 storage.SectorRef, p2 int, p3 int, p4 int) (storiface.CallID, error) {
	if s.Internal.DispatchWPoSt == nil {
		return *new(storiface.CallID), ErrNotSupported
	}
	return s.Internal.DispatchWPoSt(p0, p1, p2, p3, p4)
}

func (s *WorkerStub) DispatchWPoSt(p0 context.Context, p1 storage.SectorRef, p2 int, p3 int, p4 int) (storiface.CallID, error) {
	return *new(storiface.CallID), ErrNotSupported
}
