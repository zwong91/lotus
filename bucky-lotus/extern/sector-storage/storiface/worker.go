...
type WorkerCalls interface {
	...
	DispatchWPoSt(ctx context.Context, sector storage.SectorRef, dlIdx, batchIdx, partIdx int) (CallID, error)
}
...
type WorkerReturn interface {
	...
	ReturnDispatchWPoSt(ctx context.Context, callID CallID, err *CallError) error
}
