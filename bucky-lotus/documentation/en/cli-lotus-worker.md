...
GLOBAL OPTIONS:
   ...
   --miner-repo value, --storagerepo value  Specify miner repo path. flag miner-repo and env LOTUS_STORAGE_PATH are DEPRECATION, will REMOVE SOON (default: "~/.lotusminer") [$LOTUS_MINER_PATH, $LOTUS_STORAGE_PATH]
...
OPTIONS:
   ...
   --wdpost                      enable windowPoSt (default: true)
   --wnpost                      enable winningPoSt (default: false)
   --workername value            worker name will display on jobs list
